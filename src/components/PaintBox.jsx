  ...
  return (
    ...
    >
      <div className={`w-full border-b-[3rem] border-dark-blue`}>
          ...
          {/* <img src={paint_tools_double} alt=" " className={`absolute w-[5rem] hidden sm:block sm:w-[8rem] top-[7rem] sm:top-[9rem] left-[1.25rem] sm:left-[1.75rem]`} /> */}
      </div>
      ...
      <div className={`relative pl-[3.5rem]`}>
        <div className={`${styles.about} mt-[3rem] pb-[2rem] min-h-[30.3rem] overflow-x-hidden bg-white border-[3px] border-black`}>
          <h2 className={`mt-[1.5rem] ml-[0.75rem] sm:ml-[1.5rem] md:ml-[0.75rem]`}>
            <svg
              viewBox="0 0 500 150"
              xmlns="http://www.w3.org/2000/svg"
              role="img"
              aria-labelledby="heading"
              className="h-[3.5rem] sm:h-[5rem] md:h-[3.5rem] mt-[-1.25rem] ml-[1rem] mb-[-2rem] sm:mb-[-3rem] md:mb-[-2rem]"
            >
            ...
            <svg
              ...
              role="img"
              aria-labelledby="heading"
              className="h-[3.5rem] sm:h-[5rem] md:h-[3.5rem] mb-[0.5rem] lg:mb-[-0.5rem] md:mb-[0.5rem]"
            >
